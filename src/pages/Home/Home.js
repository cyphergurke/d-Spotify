  ...
  return (
    <>
      <Tabs defaultActiveKey="1" centered>
        ...
        <TabPane tab="STREAMS" key="2">
          <h1 className="featuredTitle">Current Streams</h1>
          <div className="albums">
            {library.map((e) => (
              <Link to="/album" state={e} className="albumSelection">
                <img
        ...
        <TabPane tab="GENRES & MOODS" key="3">
          <h1 className="featuredTitle">Pop Music</h1>
          <div className="albums">
            {library.slice(7, 13).map((e) => (
              <Link to="/album" state={e} className="albumSelection" onClick={(e) => console.log(e + "MIAUUUU")}>
                <img
                  src={e.image}
                  alt="bull"
                  style={{ width: "150px", marginBottom: "10px" }}
